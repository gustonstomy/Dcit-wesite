...
<!-- ===========================Header Section======================================== -->
<div class="bg-gray-800 text-[#FFFFFF] py-8 text-center">
  <h1 class="text-4xl font-bold">About Us</h1>
    ...
    <!-- ===============================Mission and Vission========================== -->
    <div class="flex flex-col lg:flex-row h-[54vh]  md:h-[35vh] lg:h-[60vh] xl:h-[50vh]">
      <div class="bg-[#0d2980] bg-opacity-85 flex flex-col justify-center w-full lg:w-1/2 p-5 md:px-10 lg:h-[20em] ">
        <h1 class="text-[#FFFFFF] text-[1.5em] md:text-3xl mb-4  justify-center text-center">Our Vision</h1>
      ...
      <div class="bg-[#ca7259]   flex flex-col justify-center w-full lg:w-1/2 p-5 md:px-10 lg:h-[20em] ">
        <h1 class="text-[#FFFFFF] text-[1.5em] md:text-3xl mb-4  justify-center text-center">Our Mission</h1>
        <p class="text-[#ffffff] leading-[2rem] text-[1.2em] md:text-xl mb-6">
    ...
    <!-- ==============================History========================================= -->
     ...
     <div class="px-2 md:px-32 ">
         <p class="text-justify px-4 md:px-16">
      ...
      <p class="text-justify px-2 md:px-32">

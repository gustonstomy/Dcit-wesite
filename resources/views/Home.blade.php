  ...
  <!-- ==================slider==================================== -->
   <div class="relative w-full h-[35rem] mb-8" id="slider">
        <div class="absolute w-full h-full opacity-100 transition-opacity duration-500 ease-in-out">
            ...
            <div class="absolute bottom-[10%] left-1/2 transform -translate-x-1/2 bg-[#111111] bg-opacity-50 text-[#FFFFFF] px-4 py-2 rounded-md">
                <h2 class="m-0 w-[14em] md:w-[16em] text-xl md:text-2xl [#FFFFFF]space-pre-wrap">BSc. Computer Science Studentswho graduate from the programme will be able to apply their skills to a variety of industries</h2 class="m-0 w-[16em] md:w-[16em] text-xl md:text-2xl [#FFFFFF]space-pre-wrap">
            </div>
        </div>
         <div class="absolute w-full h-full opacity-0 transition-opacity duration-500 ease-in-out">
            ...
            <div class="absolute bottom-[10%] left-1/2 transform -translate-x-1/2 bg-[#111111] bg-opacity-50 text-[#FFFFFF] px-4 py-2 rounded-md">
                <h2 class="m-0 w-[14em] md:w-[16em] text-xl md:text-2xl [#FFFFFF]space-pre-wrap">Undergraduate Programmes Bachelor of Computer Science Bachelor of Information Technology</h2 class="m-0 w-[16em] md:w-[16em] text-xl md:text-2xl [#FFFFFF]space-pre-wrap">
            </div>
        </div>
        <div class="absolute w-full h-full opacity-0 transition-opacity duration-500 ease-in-out">
        ...
        <div class="absolute w-full h-full opacity-0 transition-opacity duration-500 ease-in-out">
            ...
            <div class="absolute bottom-[10%] left-1/2 transform -translate-x-1/2 bg-[#111111] bg-opacity-50 text-[#FFFFFF] px-4 py-2 rounded-md">
                <h2 class="m-0 w-[14em] md:w-[16em] text-xl md:text-2xl [#FFFFFF]space-pre-wrap">Your further in Tech begins here!Apply now to secure your spot <br>at  UCC  and embark on ajourney  filled with  innovation and endless opportunities</h2 class="m-0 w-[16em] md:w-[16em] text-xl md:text-2xl [#FFFFFF]space-pre-wrap">
            </div>
        </div>
    </div>
    ...
    <!-- Text Section -->
    <div class="w-full xl:w-2/5 text-justify text-gray-700 text-base lg:text-lg mb-8 lg:ml-1 xl:ml-40">
      {!! $homePage->content !!}
  ...
  <div class="flex flex-col lg:flex-row xl:flex-row items-center gap-8 lg:gap-12 xl:pl-40 xl:pr-40">
    ...
    <div class="flex flex-col xl:flex-row items-center mb-8 w-full lg:w-1/3 border border-transparent">
      ...
      <div class="flex flex-col text-center">
        ...
        <p class="text-gray-700 text-md break-words">Our students are in the global competition.</p>
      </div>
    </div>
    <!-- Feature Card 2 -->
    <div class="flex flex-col xl:flex-row items-center mb-8 w-full lg:w-1/3 border border-transparent">
      ...
      <div class="flex flex-col text-center">
        ...
        <p class="text-gray-700 text-md break-words">We facilitate Online Tuition.</p>
      </div>
    </div>
    <!-- Feature Card 3 -->
    <div class="flex flex-col xl:flex-row items-center mb-8 w-full lg:w-1/3 border border-transparent">
      ...
      <div class="flex flex-col text-center">
        ...
        <p class="text-gray-700 text-md break-words">Overall Best University in West Africa.</p>
      </div>
    </div>
  </div>
    ...
    <div class="flex flex-col items-center text-center p-2 xl:p-0 w-[20rem] h-[60vh] md:h-[65vh]  sm:w-auto sm:h-[65vh] md:w-[40rem] lg:w-[32rem] lg:h-[45vh] xl:w-[35rem] xl:h-[70vh] lg:ml-2 xl:ml-40">
      <img
        src="/comput-SC.png"
        alt="Undergraduate"
      ...
      <p class="text-[1.1rem] text-gray-700 mb-5">
...
<!-- =============Delivering the World Class Education====================================== -->
 <div class="flex flex-col lg:flex-row lg:flex-wrap justify-center items-center bg-blue-900 p-8 md:pl-5 md:pr-5 lg:p-8 md:px-40 mb-8">
    <h2 class="w-full text-center text-[#FFFFFF] text-2xl md:text-[2.5rem] leading-relaxed mb-8 lg:mb-12">
      Delivering the World Class Education
    </h2>

    <!-- Social Events -->
    <div class="bg-[#FFFFFF] w-full md:w-[80%] lg:w-[45%] xl:w-[25%] h-[30vh] md:h-[40vh] lg:h-[30vh] xl:h-[40vh] p-5 rounded-lg text-left flex flex-col items-start mb-7 lg:mx-3">
      ...
      <h3 class="text-2xl md:text-[3rem] lg:text-[2.2rem] xl:text-[1.8rem] text-[#111111] bg-[#FFFFFF] leading-relaxed md:mt-8 xl:mt-0 mb-4 xl:mb-2">Social Events</h3>
      <p class="text-xl md:text-[2rem] lg:text-[1.3rem] xl:text-[1rem] text-gray-700 leading-relaxed md:leading-normal">
    ...
    <div class="bg-[#FFFFFF] w-full md:w-[80%] lg:w-[45%] xl:w-[25%] h-[30vh] md:h-[40vh] lg:h-[30vh] xl:h-[40vh] p-5 rounded-lg text-left flex flex-col items-start mb-7 lg:mx-3">
      ...
      <h3 class="text-2xl md:text-[3rem] lg:text-[2.2rem] xl:text-[1.8rem] text-[#111111] bg-[#FFFFFF] leading-relaxed md:mt-8 xl:mt-0 mb-4 xl:mb-2">Certified Lecturers</h3>
      <p class="text-xl md:text-[2rem] lg:text-[1.3rem] xl:text-[1rem] text-gray-700 leading-relaxed md:leading-normal">
    ...
    <div class="bg-[#FFFFFF] w-full md:w-[80%] lg:w-[45%] xl:w-[25%] h-[30vh] md:h-[40vh] lg:h-[30vh] xl:h-[40vh] p-5 rounded-lg text-left flex flex-col items-start mb-7 lg:mx-3">
      ...
      <h3 class="text-2xl md:text-[3rem] lg:text-[2.2rem] xl:text-[1.8rem] text-[#111111] bg-[#FFFFFF] leading-relaxed md:mt-8 xl:mt-0 mb-4 xl:mb-2">Internship Opportunities</h3>
      <p class="text-xl md:text-[2rem] lg:text-[1.3rem] xl:text-[1rem] text-gray-700 leading-relaxed md:leading-normal">
    ...
    <div class="bg-[#FFFFFF] w-full md:w-[80%] lg:w-[45%] xl:w-[25%] h-[30vh] md:h-[40vh] lg:h-[30vh] xl:h-[40vh] p-5 rounded-lg text-left flex flex-col items-start mb-7 lg:mx-3">
      ...
      <h3 class="text-2xl md:text-[3rem] lg:text-[2.2rem] xl:text-[1.8rem] text-[#111111] bg-[#FFFFFF] leading-relaxed md:mt-8 xl:mt-0 mb-4 xl:mb-2">Global Community</h3>
      <p class="text-xl md:text-[2rem] lg:text-[1.3rem] xl:text-[1rem] text-gray-700 leading-relaxed md:leading-normal">
    ...
    <div class="bg-[#FFFFFF] w-full md:w-[80%] lg:w-[45%] xl:w-[25%] h-[30vh] md:h-[40vh] lg:h-[30vh] xl:h-[40vh] p-5 rounded-lg text-left flex flex-col items-start mb-7 lg:mx-3">
      ...
      <h3 class="text-2xl md:text-[3rem] lg:text-[2.2rem] xl:text-[1.8rem] text-[#111111] bg-[#FFFFFF] leading-relaxed md:mt-8 xl:mt-0 mb-4 xl:mb-2">Practical Education</h3>
      <p class="text-xl md:text-[2rem] lg:text-[1.3rem] xl:text-[1rem] text-gray-700 leading-relaxed md:leading-normal">
    ...
    <div class="bg-[#FFFFFF] w-full md:w-[80%] lg:w-[45%] xl:w-[25%] h-[30vh] md:h-[40vh] lg:h-[30vh] xl:h-[40vh] p-5 rounded-lg text-left flex flex-col items-start mb-7 lg:mx-3">
      ...
      <h3 class="text-2xl md:text-[3rem] lg:text-[2.2rem] xl:text-[1.8rem] text-[#111111] bg-[#FFFFFF] leading-relaxed md:mt-8 xl:mt-0 mb-4 xl:mb-2">Extra Activities</h3>
      <p class="text-xl md:text-[2rem] lg:text-[1.3rem] xl:text-[1rem] text-gray-700 leading-relaxed md:leading-normal">
 ...
 <div class="flex flex-col items-center text-center py-8 mt-16 mb-16">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        @foreach ($homeEvents as $event)
            <div class="p-6 rounded-lg w-80 md:w-[40rem] lg:w-[30rem] xl:w-[35rem] text-left shadow-md">
                 <div class="w-[15] md:w-[30em] ml-4 mb-3 ">
                        <img src="{{ asset('/' . $event->media) }}" alt="img" class="rounded-[2em] updatable w-[15] md:w-[30em] h-[10em] md:h-[15em]">
                    </div>
                <h3 class="mt-4 text-xl text-[#111111] bg-[#FFFFFF]">{{ $event->name }}</h3>
                <div class="flex justify-between items-center pl-2  pr-8 md:pr-16 mt-4">
                      <div class="flex items-center ">
                            <span class="border-2 border-gray-600 rounded-full w-6 h-6 text-center leading-5 mr-2">➜</span>
                            {{ $event->time->format('h:i A') }}
                        </div>
                        <div class=" text-black py-2 px-4  text-sm inline-block">
                            <span>{{ $event->date->format('d M') }}</span>
                        </div>
                    </div>
                <div class="my-4 text-lg text-gray-700 flex flex-col items-start gap-2">
